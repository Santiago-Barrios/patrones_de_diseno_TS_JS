...
// const editor_ = new Editor(new HTMLPainter(content));
// const editor_ = new Editor(new CanvasPainter(canvas));
const editor_ = new EditorWithClear(new CanvasPainter(canvas));

range.addEventListener("input", (e) => {
    const width = e.target.value;
    const height = e.target.value;
    const color = editorColor.value;
    editor_.print(width, height, color)
});
...
clearEditor.addEventListener('click', (e) => {
    editor_.clear()
})
