...
class NormalPersonBuilden implements PersonBuilder {
  name: string;
  lastName: string;
  age: number;
  country: string;
...
// creación 1
const personBuilder = new NormalPersonBuilden();
const hector = personBuilder.setName("hector").setLastName("herrera").build();
...
director.createSimplePerson('david', 'barrios')
const david = personBuilder.build();
