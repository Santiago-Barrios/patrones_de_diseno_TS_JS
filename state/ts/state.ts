...
ticket.add(4); // no esta lleno falta uno
console.log(ticket.getState);
console.log(ticket.next());
console.log(ticket.next());
console.log('antes de add 3', ticket.quantity)
ticket.add(3); // con 3 queda lleno en 5
console.log('despues de add 3', ticket.quantity)
console.log(ticket.getState);
ticket.add(1); // esta lleno no se agregan
console.log(ticket.next());
console.log(ticket.getState);
console.log(ticket.next());
console.log(ticket.next());
